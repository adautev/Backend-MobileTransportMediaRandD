...
class IssuedToken(db.Model):
    ...
    valid_from = db.Column(db.DateTime(timezone=False), nullable=False, primary_key=True)
    valid_to = db.Column(db.DateTime(timezone=False), nullable=False, primary_key=True)
